 ...
 *  <a href="#" onclick="ajax("?ajax=1&get=news", "divNews"); return false">get</a>
 *
 * Example "JSON"
 *   == ajax.php
...
function ajax_submit(form_id_or_name_or_obj, container_id_or_callback) {
	...
	if (typeof(form_id_or_name_or_obj) == "string") {
		...
		if (!form) form = document.getElementById(form_id_or_name_or_obj); // by id
	} else {
